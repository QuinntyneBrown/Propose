...
const template = require("./team-member-item.component.html");
const styles = require("./team-member-item.component.scss");

export class TeamMemberItemComponent extends HTMLElement {
    constructor(
    ...
    private async _onDeleteClick(e:Event) {
        await this._teamMemberService.remove({ id: this.entity.id });        
        this.parentNode.removeChild(this);
    }

    private _onEditClick() {
        this._router.navigate(["team-member", "edit", this.entity.id]);
    }

    private _onViewClick() {
        this._router.navigate(["team-member","view",this.entity.id]);
    }
...
customElements.define(`ce-team-member-item`,TeamMemberItemComponent);
