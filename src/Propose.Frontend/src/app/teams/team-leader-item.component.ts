...
const template = require("./team-leader-item.component.html");
const styles = require("./team-leader-item.component.scss");

export class TeamLeaderItemComponent extends HTMLElement {
    constructor(
    ...
    private async _onDeleteClick(e:Event) {
        await this._teamLeaderService.remove({ id: this.entity.id });        
        this.parentNode.removeChild(this);
    }

    private _onEditClick() {
        this._router.navigate(["team-leader", "edit", this.entity.id]);
    }

    private _onViewClick() {
        this._router.navigate(["team-leader","view",this.entity.id]);
    }
...
customElements.define(`ce-team-leader-item`,TeamLeaderItemComponent);
